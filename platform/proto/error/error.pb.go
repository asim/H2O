...
// source: github.com/hailo-platform/H2O/platform/proto/error/error.proto
// DO NOT EDIT!

/*
Package com_hailo-platform/H2O_kernel_platform_error is a generated protocol buffer package.

It is generated from these files:
	github.com/hailo-platform/H2O/platform/proto/error/error.proto

It has these top-level messages:
	PlatformError
*/
package com_hailo-platform/H2O_kernel_platform_error
...
type PlatformError struct {
	Type             *PlatformError_ErrorType `protobuf:"varint,1,req,name=type,enum=com.hailo-platform/H2O.kernel.platform.error.PlatformError_ErrorType" json:"type,omitempty"`
...
func init() {
	proto.RegisterEnum("com.hailo-platform/H2O.kernel.platform.error.PlatformError_ErrorType", PlatformError_ErrorType_name, PlatformError_ErrorType_value)
}
