...
// source: github.com/hailo-platform/H2O/discovery-service/proto/register/register.proto
// DO NOT EDIT!

/*
Package com_hailo-platform/H2O_kernel_discovery_register is a generated protocol buffer package.

It is generated from these files:
	github.com/hailo-platform/H2O/discovery-service/proto/register/register.proto
...
It has these top-level messages:
	...
	Response
*/
package com_hailo-platform/H2O_kernel_discovery_register

import proto "github.com/hailo-platform/H2O/protobuf/proto"
import json "encoding/json"
import math "math"
import com_hailo-platform/H2O_kernel_discovery "github.com/hailo-platform/H2O/discovery-service/proto"
...
type Request struct {
	...
	Service          *com_hailo-platform/H2O_kernel_discovery.Service `protobuf:"bytes,4,req,name=service" json:"service,omitempty"`
...
func (m *Request) GetService() *com_hailo-platform/H2O_kernel_discovery.Service {
	if m != nil {
		return m.Service
	}
	return nil
...
func (m *MultiRequest) GetService() *com_hailo-platform/H2O_kernel_discovery.Service {
	if m != nil {
		return m.Service
	}
	return nil
