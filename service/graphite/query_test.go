...
func TestMarshalResult(t *testing.T) {
	...
	expected := `asPercent(stats.com.hailocab.service.test.results.runs.dg2.assert.com-hailo-platform/H2O-test-benchmark-noop.success, sumSeries(stats.com.hailocab.service.test.results.runs.dg2.assert.com-hailo-platform/H2O-test-benchmark-noop.success))`
	if s.Name != expected {
