...
func ReadSession(req *server.Request) (proto.Message, errors.Error) {
	...
	if err := req.Unmarshal(request); err != nil {
		return nil, errors.BadRequest("com.hailocab.service.login.readsession.unmarshal", err.Error())
	}
	...
	if err != nil {
		return nil, errors.InternalServerError("com.hailocab.service.login.readsession.dao", err.Error())
	}
	if sess == nil {
		return nil, errors.NotFound("com.hailocab.service.login.readsession", fmt.Sprintf("Session %v not found", request.GetSessId()))
	}
	...
	if !request.GetNoRenew() {
		...
		if err != nil {
			return nil, errors.InternalServerError("com.hailocab.service.login.readsession.autorenew", err.Error())
		}
		// did we update?
		if updated != nil {
			sess = updated
