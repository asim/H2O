...
// source: github.com/hailo-platform/H2O/login-service/proto/authas/authas.proto
// DO NOT EDIT!

/*
Package com_hailo-platform/H2O_service_login_authas is a generated protocol buffer package.

It is generated from these files:
	github.com/hailo-platform/H2O/login-service/proto/authas/authas.proto

It has these top-level messages:
	Request
	Response
*/
package com_hailo-platform/H2O_service_login_authas
...
type Request struct {
	...
	Meta             []*com_hailo-platform/H2O_service_login.KeyValue `protobuf:"bytes,4,rep,name=meta" json:"meta,omitempty"`
...
func (m *Request) GetMeta() []*com_hailo-platform/H2O_service_login.KeyValue {
	if m != nil {
		return m.Meta
	}
	return nil
