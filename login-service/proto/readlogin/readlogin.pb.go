...
// source: github.com/hailo-platform/H2O/login-service/proto/readlogin/readlogin.proto
// DO NOT EDIT!

/*
Package com_hailo-platform/H2O_service_login_readlogin is a generated protocol buffer package.

It is generated from these files:
	github.com/hailo-platform/H2O/login-service/proto/readlogin/readlogin.proto
...
It has these top-level messages:
	...
	Login
*/
package com_hailo-platform/H2O_service_login_readlogin
...
type Login struct {
	...
	Meta              []*com_hailo-platform/H2O_service_login.KeyValue `protobuf:"bytes,6,rep,name=meta" json:"meta,omitempty"`
	XXX_unrecognized  []byte                                 `json:"-"`
}
...
func (m *Login) GetMeta() []*com_hailo-platform/H2O_service_login.KeyValue {
	if m != nil {
		return m.Meta
	}
	return nil
